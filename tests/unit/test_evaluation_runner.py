...
from job_dedup_rag.evaluation import EvaluationCase, run_evaluation_case
            ...
            "candidates": [
                {
                    "document": Document(
                        ...
                        metadata={"job_id": "linkedin:test-match"},
                    ),
...
def test_run_evaluation_case_reports_match_and_retrieval() -> None:
    ...
    observation = run_evaluation_case(FakeGraph(), evaluation_case)
